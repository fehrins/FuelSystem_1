<%-- 
    Document   : access2
    Created on : Nov 29, 2018, 7:07:38 PM
    Author     : Admin
--%>
...
img{
    ...
    <div id="header">
            <center>
        <h1> Welcome Manager </h1> </center>
        </div>
        <div id="sidemenu">
        
            <ul>
                <li><a href="seasonalfluctuation.jsp">Seasonal Rates</a></li>
                <li><a href="transportation.jsp">Transportation</a></li>
                <li><a href="accessTable.jsp">Current Users</a></li> 
